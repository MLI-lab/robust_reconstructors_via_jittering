...
def adversarial_training(
    ...
    conv_type="None", attack_types = ["pgd"]*4, sig_energy = 10278, epochs=100, noise_level = 0.2, zetas_start = 0.0, zetas_end = 0.3, zetas_steps=11, adv_its=5, devices=["cpu"], repetitions=1, base_artifact_path = "eval"):
