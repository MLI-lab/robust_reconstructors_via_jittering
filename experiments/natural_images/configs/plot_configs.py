...
from experiments.natural_images.configs.eval_configs import (
...
unet_025SigmaRGB_denoising = {
    "base_dir_reference"            : evaluate_UNet_025SigmaStandardRGB_denoising["base_dir"],
    "base_dir_std"                  : evaluate_UNet_Jittering025SigmaRGB_denoising["base_dir"],
    "base_dir_stdl2"                : None,
    "base_dir_stdErrorReg"          : None,
    "base_dir_adv"                  : evaluate_UNet_Adversarial025SigmaRGB_denoising["base_dir"],
    "eval_df_save_dir_reference"    : evaluate_UNet_025SigmaStandardRGB_denoising["df_save_dir"],
    "eval_df_save_dir_std"          : evaluate_UNet_Jittering025SigmaRGB_denoising["df_save_dir"],
    "eval_df_save_dir_stdl2"        : None,
    "eval_df_save_dir_stdErrorReg"  : None,
    "eval_df_save_dir_adv"          : evaluate_UNet_Adversarial025SigmaRGB_denoising["df_save_dir"],
    "noise_levels_stdRef"           : evaluate_UNet_025SigmaStandardRGB_denoising["fixed_noise_levels"],
    "noise_levels_std"              : evaluate_UNet_Jittering025SigmaRGB_denoising["fixed_noise_levels"],
    "noise_levels_stdl2"            : None,
    "noise_levels_stdErrorReg"      : None,
    "noise_levels_adv"              : evaluate_UNet_Adversarial025SigmaRGB_denoising["fixed_noise_levels"],
    "global_plot_config"            : global_config,
    "specific_plot_config"          : unet_base_plot_config,
    "base_output_dir"               : os.path.join(base_artifact_path__default, step_name, "unet_025SigmaRGB_denoising"),
    "plot_filename_std"             : "unet_standard_comparison",
    "plot_filename_adv"             : "unet_adversarial_comparison"
}

unet_025SigmaRGB_gaussian8x8 = {
    "base_dir_reference"            : evaluate_UNet_025SigmaStandardRGB_gaussian8x8["base_dir"],
    "base_dir_std"                  : evaluate_UNet_Jittering025SigmaRGB_gaussian8x8["base_dir"],
    "base_dir_stdl2"                : None,
    "base_dir_stdErrorReg"          : None,
    "base_dir_adv"                  : evaluate_UNet_Adversarial025SigmaRGB_gaussian8x8["base_dir"],
    "eval_df_save_dir_reference"    : evaluate_UNet_025SigmaStandardRGB_gaussian8x8["df_save_dir"],
    "eval_df_save_dir_std"          : evaluate_UNet_Jittering025SigmaRGB_gaussian8x8["df_save_dir"],
    "eval_df_save_dir_stdl2"        : None,
    "eval_df_save_dir_stdErrorReg"  : None,
    "eval_df_save_dir_adv"          : evaluate_UNet_Adversarial025SigmaRGB_gaussian8x8["df_save_dir"],
    "noise_levels_stdRef"           : evaluate_UNet_025SigmaStandardRGB_gaussian8x8["fixed_noise_levels"],
    "noise_levels_std"              : evaluate_UNet_Jittering025SigmaRGB_gaussian8x8["fixed_noise_levels"],
    "noise_levels_stdl2"            : None,
    "noise_levels_stdErrorReg"      : None,
    "noise_levels_adv"              : evaluate_UNet_Adversarial025SigmaRGB_gaussian8x8["fixed_noise_levels"],
    "global_plot_config"            : global_config,
    "specific_plot_config"          : unet_base_plot_config,
    "base_output_dir"               : os.path.join(base_artifact_path__default, step_name, "unet_025SigmaRGB_gaussian8x8"),
    "plot_filename_std"             : "unet_standard_comparison",
    "plot_filename_adv"             : "unet_adversarial_comparison"
}

from generic.step import ExperimentStep
from experiments.natural_images.steps.plot import plot

plot_step_configs = {
    "unet_025SigmaRGB_denoising" : ExperimentStep(
        step_func=plot,
        artifact_path=unet_025SigmaRGB_denoising["base_output_dir"],
        parameters=unet_025SigmaRGB_denoising
    ),
    "unet_025SigmaRGB_gaussian8x8" : ExperimentStep(
        step_func=plot,
        artifact_path=unet_025SigmaRGB_gaussian8x8["base_output_dir"],
        parameters=unet_025SigmaRGB_gaussian8x8
    )
}