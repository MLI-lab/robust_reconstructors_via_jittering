...
from experiments.subspace.configs.eval_configs import (
...
uc_subspace_denoising = {
    "base_dir_reference"            : evaluate_standard_subspace_denoising["base_dir"],
    "base_dir_std"                  : evaluate_jittering_subspace_denoising["base_dir"],
    "base_dir_stdl2"                : None,
    "base_dir_stdErrorReg"          : None,
    "base_dir_adv"                  : evaluate_adversarial_subspace_denoising["base_dir"],
    "eval_df_save_dir_reference"    : evaluate_standard_subspace_denoising["df_save_dir"],
    "eval_df_save_dir_std"          : evaluate_jittering_subspace_denoising["df_save_dir"],
    "eval_df_save_dir_stdl2"        : None,
    "eval_df_save_dir_stdErrorReg"  : None,
    "eval_df_save_dir_adv"          : evaluate_adversarial_subspace_denoising["df_save_dir"],
    "noise_levels_stdRef"           : evaluate_standard_subspace_denoising["fixed_noise_levels"],
    "noise_levels_std"              : evaluate_jittering_subspace_denoising["fixed_noise_levels"],
    "noise_levels_stdl2"            : None,
    "noise_levels_stdErrorReg"      : None,
    "noise_levels_adv"              : evaluate_adversarial_subspace_denoising["fixed_noise_levels"],
    "global_plot_config"            : global_config,
    "specific_plot_config"          : unet_base_plot_config,
    "base_output_dir"               : os.path.join(base_artifact_path__default, step_name, "uc_subspace_denoising"),
    "plot_filename_std"             : "ucsubspace_standard_comparison",
    "plot_filename_adv"             : "ucsubspace_adversarial_comparison"
}

uc_subspace_linear_decay = {
    "base_dir_reference"            : evaluate_standard_subspace_linear_decay["base_dir"],
    "base_dir_std"                  : evaluate_jittering_subspace_linear_decay["base_dir"],
    "base_dir_stdl2"                : None,
    "base_dir_stdErrorReg"          : None,
    "base_dir_adv"                  : evaluate_adversarial_subspace_linear_decay["base_dir"],
    "eval_df_save_dir_reference"    : evaluate_standard_subspace_linear_decay["df_save_dir"],
    "eval_df_save_dir_std"          : evaluate_jittering_subspace_linear_decay["df_save_dir"],
    "eval_df_save_dir_stdl2"        : None,
    "eval_df_save_dir_stdErrorReg"  : None,
    "eval_df_save_dir_adv"          : evaluate_adversarial_subspace_linear_decay["df_save_dir"],
    "noise_levels_stdRef"           : evaluate_standard_subspace_linear_decay["fixed_noise_levels"],
    "noise_levels_std"              : evaluate_jittering_subspace_linear_decay["fixed_noise_levels"],
    "noise_levels_stdl2"            : None,
    "noise_levels_stdErrorReg"      : None,
    "noise_levels_adv"              : evaluate_adversarial_subspace_linear_decay["fixed_noise_levels"],
    "global_plot_config"            : global_config,
    "specific_plot_config"          : unet_base_plot_config,
    "base_output_dir"               : os.path.join(base_artifact_path__default, step_name, "uc_subspace_linear_decay"),
    "plot_filename_std"             : "ucsubspace_standard_comparison",
    "plot_filename_adv"             : "ucsubspace_adversarial_comparison"
}
...
from experiments.subspace.steps.plot import plot

plot_step_configs = {
    "subspace_denoising" : ExperimentStep(
        step_func=plot,
        artifact_path=uc_subspace_denoising["base_output_dir"],
        parameters=uc_subspace_denoising
    ),
    "subspace_linear_decay" : ExperimentStep(
        step_func=plot,
        artifact_path=uc_subspace_linear_decay["base_output_dir"],
        parameters=uc_subspace_linear_decay
    )
}